                  ...
                  <tbody>
                        ...
                        @foreach ($carts as $cart)
                            <tr>
                                ...
                                <td style="width: 40%">
                                    <div class="product-title">KZT {{ number_format($cart->product->price) }}</div>
                                </td>
                                <td style="width: 20%">
                ...
                <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="row" data-aos="fade-up" data-aos-delay="200">
                    <div class="col-4 col-md-2">
                      <div class="product-title">KZT 1000</div>
                      <div class="product-subtitle">Country Tax</div>
                    </div>
                    <div class="col-4 col-md-3">
                      <div class="product-title">KZT 10000</div>
                    ...
                    <div class="col-4 col-md-2">
                      <div class="product-title text-success">KZT {{ number_format($totalPrice + 30000 ?? 0) }}</div>
